...
Error: File to import not found or unreadable: bourbon/bourbon.
        ...
        from line 1 of outer-container.scss
...
4: 
5: .container-default {
6:   @include outer-container();

Backtrace:
_setup.scss:1
outer-container.scss:1
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: bourbon/bourbon.\A         on line 1 of _setup.scss\A         from line 1 of outer-container.scss\A \A 1: @import 'setup';\A 2: \A 3: $max-width: 960px;\A 4: \A 5: .container-default {\A 6:   @include outer-container();"; }
