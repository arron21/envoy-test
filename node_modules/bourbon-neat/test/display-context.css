...
Error: File to import not found or unreadable: bourbon/bourbon.
        ...
        from line 1 of display-context.scss

1: @import 'setup';
2: 
3: @include display-context(table) {
4:   .display-table-block {
5:     @include span-columns(6);
6:   }

Backtrace:
_setup.scss:1
display-context.scss:1
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: bourbon/bourbon.\A         on line 1 of _setup.scss\A         from line 1 of display-context.scss\A \A 1: @import 'setup';\A 2: \A 3: @include display-context(table) {\A 4:   .display-table-block {\A 5:     @include span-columns(6);\A 6:   }"; }
